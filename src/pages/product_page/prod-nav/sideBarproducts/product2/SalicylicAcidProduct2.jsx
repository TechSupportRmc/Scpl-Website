    ...
    <Layout>
       <div className="slides-about">
        ...
        <div className="prod-container">
          <ProdNav />
          <div className="prod-2-right-content">
            <h1>Salicylic Acid (IP/BP/USP)</h1>
          ...
          <p><span>Iron:</span> 2 ppm (max.) I.P.</p>
            ...
            <button className='product-2-btn'><a href="/salicylic">View Product</a></button>
          </div>
        </div>
    </Layout>
  )
...
export default SalicylicAcidProduct2
