  ...
  return (
    ...
    <div className="slides-about">
     ...
     <div className="prod-container">
       <ProdNav />
       <div className="prod-7-right-content">
         <h1>Aspirin</h1>
         <p>2-ACETOXYBENZOIC ACID</p>
        ...
        <p><span>Loss on drying:</span> Max 0.5%</p>
         ...
         <div className="product-7-image">
           <img src="../../product-black-svg/aspirin.svg" alt="" />
         </div>
         <button className='product-7-btn'><a href="/aspirin">View Product</a></button>
       </div>
     </div>
 </Layout>
  )
...
export default AspirinProduct7
