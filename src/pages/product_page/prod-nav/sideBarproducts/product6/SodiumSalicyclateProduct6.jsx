...
`;
const SodiumSalicyclateProduct6 = () => {
  ...
  return (
    ...
    <div className="slides-about">
     ...
     <div className="prod-container">
       <ProdNav />
       <div className="prod-6-right-content">
         <h1>Sodium Salicylate</h1>
         ...
         <div className="product-6-image">
           <img src="../../product-black-svg/sodium.svg" alt="" />
         </div>
         <button className='product-6-btn'><a href="/sodium">View Product</a></button>
       </div>
     </div>
 </Layout>
  )
...
export default SodiumSalicyclateProduct6
