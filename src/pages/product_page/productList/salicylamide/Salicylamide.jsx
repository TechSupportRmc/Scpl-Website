...
const Salicylamide = () => {
  ...
  return (
    <Layout>
      <div className="bg-product_6">
        <div className="product_6">
          <div className="product_6-overlay">
            <p>O-HYDROXY BENZAMIDE</p>
            <h2>Salicylamide NF</h2>
            <img src="../../product-svg/Salicylamide.svg" alt="" />
          </div>
        </div>
      </div>
